...
using Beers.IS4Host.Data;
using Beers.IS4Host.Models;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var builder = services.AddIdentityServer(options =>
            {
                ...
                sqlServerOptionsAction:sql=>sql.MigrationsAssembly(migrationAssembly));
                })
                .AddConfigurationStore(operationDb=>
